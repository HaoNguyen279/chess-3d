...
export function CapturedPieces() {
  ...
  return (
    <div className="bg-black/70 backdrop-blur-sm rounded-lg p-4 border border-gray-700">
      <div className="text-sm font-semibold text-gray-300 mb-3">Captured Pieces</div>
      
      <div className="space-y-3">
        <div>
          <div className="text-xs text-gray-400 mb-1">White captured</div>
        ...
        <div>
          <div className="text-xs text-gray-400 mb-1">Black captured</div>
          <div className="flex flex-wrap gap-1 min-h-[28px]">
